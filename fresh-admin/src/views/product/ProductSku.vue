    ...
    <el-card shadow="never">
      <SearchForm :initForm="searchForm" @search="handleSearch" @reset="handleReset">
        <el-form-item label="SKU名称" prop="name">
          <el-input v-model="searchForm.name" placeholder="请输入SKU名称" clearable />
        </el-form-item>
        <el-form-item label="商品" prop="productId">
          <el-select v-model="searchForm.productId" placeholder="请选择商品" clearable style="width: 150px">
      ...
      <div class="table-header">
        <span>SKU管理</span>
        <el-button type="primary" :icon="Plus" @click="handleAdd">新增SKU</el-button>
      </div>
      ...
      >
        ...
        <el-table-column prop="productName" label="所属商品" width="120" />
